...
# I16 is the ONE exception: it is the packed-code carrier of trellis-coded
# weights, and on the in-kernel decode lane the codes buffer reaches the kernel
# as raw int16 words (``backend/cuda/dtype.py``). Folded, it binds bit-identically
# through the loader and never reaches a kernel, like I32/I64.
