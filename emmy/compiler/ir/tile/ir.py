...
class TileOp(Op):
    ...
    # Whether the structural cross-CTA split fork (``035_split_reduce``) kept this kernel whole.
    # Split pieces need no flag: their sliced axis's partition ``Window`` is the receipt.
    split_decided: bool = False
