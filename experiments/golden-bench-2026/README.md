...
Emmy case does not discard later PyTorch/Emmy rows. The experiment row still fails unless every requested setup has
both repeated O3 replays and both strict source references. An incomplete setup is unsupported evidence, not a
performance result.
