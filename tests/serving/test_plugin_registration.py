...
def test_deepseek_opt_in_registers_every_broad_adapter(monkeypatch):
    ...
    from emmy.serving import onecat, onecat_deepseek, onecat_indexer, onecat_linear, onecat_mhc, onecat_output, onecat_vocab
    ...
    assert calls == ["logging", "rms_norm", "deepseek", "linear", "mhc", "output", "vocab", "indexer"]
